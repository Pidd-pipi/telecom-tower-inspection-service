...
const opsDomainName = "telecom-tower-inspection-service"
...
func opsStatusActiveish(status OpsStatus) bool {
	return status == OpsStatusActive || status == OpsStatusReview
}
...
func opsCreateSequence() uint64 { return atomic.AddUint64(&opsCreateCounter, 1) }
