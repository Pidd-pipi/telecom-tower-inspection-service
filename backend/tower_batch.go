...
func newTowerBatchProcessor(store *InspectionStore, audit *TowerAudit, planner *TowerPlanner) *TowerBatchProcessor {
	return &TowerBatchProcessor{store: store, audit: audit, planner: planner, lease: make(chan struct{}, 1)}
}
